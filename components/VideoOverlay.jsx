...
export default function VideoOverlay(props) {
    return (
        <section className='p-0 video_overlay_blade  hide' id='overlay'>
            <div className={`overlay transition-all duration-300 xl-up:w-[calc(100%-276px)] desktop:w-[calc(100%-244px)] wide-nav-screen:max-w-[2500px] wide-nav-screen:mx-auto  fixed w-screen h-screen z-[9999] ${Style.overlay}`}>
                <div className={`${Style.overlaycardsWrap} relative top-[50%] tablet-landscape:top-0 md:top-0 lg:pb-[50px] pt-[70px]`}>
                    <div className={`overlay-cross w-[40px] h-[40px] cursor-pointer absolute right-[179px] -top-[27px] desktop-laptop:right-[30px] desktop-laptop:top-[45px] lg:right-[30px] lg:top-[40px]  ${Style.logoWrap} z-[9999]`} >
                        <svg
                            width="40"
                            height="40"
                            viewBox="0 0 40 40"
