...
function FooterCta() {
	return (
		<section
			className={`footer-cta relative overflow-hidden xl-up:pt-[160px] bg-black pb-0  wide-screen:pt-[240px] lg-up:pt-[125px]`}
		>
			<div className="container lg:p-0">
				...
				>
					...
					>
						<div
							className={`${styles.imageWrap} relative w-full tablet:w-auto lg:inline-block sm:max-w-[350px] max-w-[535px] sm:mb-[-10px]  xxl-up:max-w-[720px]`}
						>
							<Image
