...
export default function LogoNavTab() {
  ...
  return (
		<section
			className={`bg-skyblue tab-with-logo img-text-tab ${Style.imgTextTab} ${Style.logoTab}`}
		>
					...
					<div className="tab-content mt-[40px] laptop-landscape:mt-[30px]">
						<div className="flex flex-wrap rounded-[24px] overflow-hidden">
							...
							>
								...
								>
									<div className="flex flex-wrap pl-[40px] md:px-8 md:gap-7 justify-between tablet-mid:pb-[15px] sm:bg-darkBlue">
										{Data[activeTab].imgWithContent.count.map((data, index) => (
											<div
												key={index}
												className="py-[21px] pr-[15px] tablet-mid:w-full tablet-mid:pb-0 sm:w-full w-1/2 countWithText pd:pr-0 pd:w-full pd:mb-[10px] pd:last-of-type:mb-[0]"
											>
