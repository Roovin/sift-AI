...
export default function FullWidthPopUpWithImage(props) {
				...
				<div className={`popupWrap w-full relative mx-auto  z-10 max-w-[1165px]`}>
					<div className={`imgWithContent`}>
						...
						<div className="flex justify-between md:flex-wrap p-[64px] pb-[45px] border-[2px] border-white rounded-[16px] bg-black mx-auto overflow-hidden tablet:p-[40px] md:p-[20px]">
							...
							<div className="rightText w-[55%] md:w-full">
								{data?.title && <h3 className="mb-[16px] mt-[15px]">{data?.title}</h3>}
								{data?.blurb && <p>{data?.blurb}</p>}
								<div className="btn mt-[38px] text-black">
