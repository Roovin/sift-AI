  ...
  return (
		<>
			<Link
				...
				className={`group arrow_btn uppercase text-white relative  transition-all tracking-[1.1px]  duration-300 font-[700] leading-[1] pr-[26px] hover:text-pink  z-[11]`}
				href={props.redirection}
			>
				{props.text}
				<span className="absolute top-[auto] bottom-[-8px] wide-screen:bottom-[-4px] -translate-y-1/2 right-0 w-[20px] overflow-hidden">
					<svg
