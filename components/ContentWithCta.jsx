...
function ContentWithCta() {
	...
	return (
		<section className="ContentWithCta md-up:bg-darkBlue md-up:pt-0 z-10 md:overflow-hidden overflow-hidden">
			...
			<div className="container">
				<div
					className={`${backgroundColor} md-up:rounded-[300px] md-up:py-10 md-up:pr-10 pl-24 md:pl-0 tablet:pl-20 wide-screen:pl-[150px] md-up:overflow-hidden`}
					data-aos="fade-up"
				>
					<div className="md-up:flex md-up:justify-between">
						<div className="text-wrap relative w-3/5 md:w-full pr-5 large-desktop:pr-10 wide-screen:pr-16 md:pr-0 md:pt-0 pt-10 pb-16 md:pb-[48px] md-up:flex md-up:justify-center flex-col">
							<h3 className="mb-4">
								Seasonal <span>Promotional</span> assets lorem ipsum dolor
							</h3>
							<p>
						...
						<div className="w-[365px] laptop-landscape:w-[260px!important] desktop:w-[248px] tablet:w-[223px] md:w-[286px]  md:m-auto relative self-end">
