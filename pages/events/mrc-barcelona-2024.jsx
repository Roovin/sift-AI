...
import FooterCtaWithSlider from './FooterCtaWithSlider';
import EventDetailStyle from '../../styles/event/eventBannerDetail.module.css'
import EventLeadershipCard from './EventLeaderShipCards';
            ...
            <section className={`${EventDetailStyle.eventBannerDetail} relative flex flex-wrap`}>
                <div className="container">
                    <div className='laptop:w-[45%] w-[50%] xl:w-[50%] relative lg:!w-full xxl-up:w-[60%] wide-screen:w-[80%]'>
                        ...
                        <p>Join us at MRC Barcelona 2024, the pinnacle event for professionals in the payments and fraud prevention industry. Dive deep into cutting-edge keynotes, expert panels, and interactive networking sessions.</p>
                        <Btn_pink text="Reserve your spot" className="relative right-0" link="/events/mrc-barcelona-2024/register" />
                        {/* </div> */}
                    </div>
                </div>
                <div className="absolute top-[50%] xl:transform-none xl:top-auto laptop-mid:max-w-[450px] laptop-small:max-w-[400px] desktop-mid:max-w-[350px] phablet:max-w-[450px] sm:max-w-[300px] sm:mx-auto xl:ml-auto xl:mt-0 lg:!mt-[30px] mt-[30px] xl:h-auto lg:relative right-0 -translate-y-[50%] h-[380px] w-[550px] laptop:w-[49%]">
                    <Image src="/MRC-Barcelona-2024-Hero.jpeg" className='w-full h-full sm:rounded-[16px]' alt='Image' width={550} height={380} quality={25} />
                </div>
            </section>
                ...
                <div className="container">
                    <div>
                        ...
                        <div>
                            ...
                            <p><b>Next-level Networking</b></p>
                            <p>
                                <span>Interact with fraud experts from Sift, as well as payments peers 
                                and thought leaders from across the globe.
                                </span>
                            </p>
                            <p><b>Industry Intelligence</b></p>
                            <p>
                                <span>Attend one-of-a-kind keynote speeches, panel discussions, 
                                    and presentations by payments and fraud management experts.
                                </span>
                            </p>
                            <p><b>Business Development</b></p>
                            <p>
                                <span>Workshops, seminars, and sessions at MRC Barcelona delve into new 
                                    technologies, strategies, and best practices in eCommerce.
                                </span>
                            </p>
                        </div>
                        <div className="laptop-down:hidden">
                            <div><p className="small_font font-[700!important] border-t-[1px] desktop-laptop:text-[16px] xl-[14px] laptop-landscape:text-[16px] pt-[16px] lg:!text-[16px] border-black ">
                                You may also like</p>
                                <article className="relative hover:outline-[1px] p-[24px!important] outline outline-[2px] transition-all delay-200 rounded-[16px] border-black md-up:shadow-none md-up:hover:shadow-eventCards-shadow">
                                    <Link className="emptyLink" href="/blog/what-is-money-movement">.</Link>
                                    <p className="text-blue text-[14px] font-[700] uppercase">Payment Fraud</p>
                                    <h4>What is Money Movement?</h4>
                                </article>
                                <article className="relative hover:outline-[1px] p-[24px!important] outline outline-[2px] transition-all delay-200 rounded-[16px] border-black md-up:shadow-none md-up:hover:shadow-eventCards-shadow">
                                    <Link className="emptyLink" href="/blog/the-era-of-ai-powered-risk-decisioning">.</Link>
                                    <p className="text-blue text-[14px] font-[700] uppercase">Company</p>
                                    <h4>Ushering in the Era of AI-Powered Fraud Decisioning</h4>
                                </article>
                                <article className="relative hover:outline-[1px] p-[24px!important] outline outline-[2px] transition-all delay-200 rounded-[16px] border-black md-up:shadow-none md-up:hover:shadow-eventCards-shadow">
                                    <Link className="emptyLink" href="/blog/dispute-data-consumer-insights-and-emerging-trends-from-2023">.</Link>
                                    <p className="text-blue text-[14px] font-[700] uppercase">Chargebacks</p>
                                    <h4>Dispute data, consumer insights, and emerging trends from 2023</h4>
                                </article>
                                <article className="relative hover:outline-[1px] p-[24px!important] outline outline-[2px] transition-all delay-200 rounded-[16px] border-black md-up:shadow-none md-up:hover:shadow-eventCards-shadow">
                                    <Link className="emptyLink" href="/blog/7-types-of-food-delivery-scams-and-how-to-stop-them">.</Link>
                                    <p className="text-blue text-[14px] font-[700] uppercase">Account Fraud</p>
                                    <h4>7 types of food delivery scams and how to stop them</h4>
                                </article>
                            </div>
                        </div>
                    </div>
