...
import ColFourCard from '../../components/ColFourCard';
...
// import EventLeaderShipCards from '../../components/event-sections/eventLeaderShipCards'
...
// if(window.width > 991) {
  ...
  const iconData = [
    {
      "id":"1",
      "icon": "/EventDetail/location.svg",
      "title":"Virtual"
    },
    {
      "id":"2",
      "icon": "/EventDetail/clock.svg",
      "title":"11 A.M. PT / 2 P.M. ET"
    },
    {
      "id":"3",
      "icon": "/EventDetail/calendar-check-fill.svg",
      "title":"Dec 6, 2023"
    },
  ];
  ...
  return (
    <Layout>
        <NextSeo title="Events - Sift" description="Sift - Events" />
      <div className="breadcrumbs bg-white relative">
				<div className="container">
					<ul className='absolute top-[39px] left-[20px] sm:z-[9] z-[99] sm:top-[75px] phablet:top-[70px] tablet:top-[60px]'>
            ...
            <li className='inline relative text-[16px] font-[700] leading-[24px] mr-[15px]'>
							<span className='text-pink'>Event Detail</span>
						</li>
					</ul>
				</div>
			</div>
      <section className={`${EventDetailStyle.eventBannerDetail} relative flex flex-wrap`}>
        <div className="container">
            <div className='laptop:w-[45%] w-[50%] xl:w-[50%] relative lg:!w-full xxl-up:w-[60%] wide-screen:w-[80%]'>
              <Link  href={"/"}>
              <span className={` ${inter.className}`}>in-person conference</span>
              </Link>
              <h3>Enim ipsum dolor sit amet, consect adipiscing</h3>
              <div>
                {iconData.map((item, i) => {
                  return (
                    <div key={i}>
                      <Image src={item.icon} alt='' width={24} height={24}/>
                      <span className={` small_font font-[700!important] ${inter.className}`}>{item.title}</span>
                    </div>
                  )
                })}
              </div>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra adipiscing est, venenatis labore et dolore magna aliqua.</p>
              <Btn_pink text="Reserve your spot" className="relative right-0" link="/gated-resource-html" />
            {/* </div> */}
          </div>
        </div>
        <div className="absolute top-[50%] xl:transform-none xl:top-auto laptop-mid:max-w-[450px] laptop-small:max-w-[400px] desktop-mid:max-w-[350px] phablet:max-w-[450px] sm:max-w-[300px] sm:mx-auto xl:ml-auto xl:mt-0 lg:!mt-[30px] mt-[30px] xl:h-auto lg:relative right-0 -translate-y-[50%] h-[380px] w-[550px] laptop:w-[49%]">
          <Image src="/EventDetail/eventBanner.png" className='w-full h-full sm:rounded-[16px]' alt='Image' width={550} height={380} quality={25} />
        </div>
      </section>
          ...
          <div>
          {
              winWidth > 991 ?
                ...
                <div style={isScrolled ? height : { top: ribbonHeight }}>
                    <Link href="#" className='text-[0] h-full'>
            ...
            <div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Aliquet lectus proin nibh nisl condimentum id. Tristique senectus et netus et malesuada fames ac turpis. Massa massa ultricies mi quis hendrerit dolor magna. Sollicitudin ac orci phasellus egestas tellus rutrum. Condimentum mattis pellentesque id nibh tortor id aliquet.</p>
                <p>Platea dictumst vestibulum rhoncus est. Tristique senectus et netus et malesuada. Massa placerat duis ultricies lacus sed turpis tincidunt id. Dui nunc mattis enim ut tellus elementum sagittis. Tristique et egestas quis ipsum suspendisse. Sed id semper risus in hendrerit gravida. Sodales ut eu sem integer vitae justo eget magna. </p>
                <h4>Excepteur Lorem sint occaecat proident</h4>
                <p>Nulla aliquet enim tortor at auctor urna nunc id. Id aliquet risus feugiat in ante. Pulvinar sapien et ligula ullamcorper malesuada proin libero. Neque viverra justo nec ultrices dui sapien eget. Scelerisque eleifend donec.</p>
                <ul>
                  <li>
                    <h6 className={inter.className}>1. Networking and collaboration</h6>
                    <p>Interact with peers, investors, and thought leaders from the financial and technology industries across the globe. Network, make valuable connections, and explore potential business partnerships.</p>
                  </li>
                  <li>
                    <h6 className={inter.className}>2. Industry insights and intelligence</h6>
                    <p>Attend one-of-a-kind keynote speeches, panel discussions, and presentations by fintech and banking experts, and gain insights into emerging market trends, innovations, and ongoing challenges.</p>
                  </li>
                  <li>
                    <h6 className={inter.className}>3. Business development and education</h6>
                    <p>Workshops, seminars, and educational sessions at Money20/20 cover the latest technologies, strategies, and best practices in payments, digital banking, blockchain, artificial intelligence, and other industries.</p>
                  </li>
                </ul>
                <Image src='/EventDetail/events.png' alt='Image' width={669} height={400} quality={25} />
            ...
            <div>
            <div>
                <p className={`small_font font-[700!important] border-t-[1px] desktop-laptop:text-[16px] xl-[14px] laptop-landscape:text-[16px] pt-[16px] lg:!text-[16px] border-black `}>You may also like</p>
                {cardData.map((item, i) => {
                  return (
                    <article key={i} className="relative hover:outline-[1px] p-[24px!important] outline outline-[2px] transition-all delay-200 rounded-[16px] border-black md-up:shadow-none md-up:hover:shadow-eventCards-shadow">
                      ...
                      <p className='text-blue text-[14px] font-[700] uppercase'>{item.title}</p>
